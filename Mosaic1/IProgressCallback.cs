...
namespace MWA.Progress
{
	...
	public interface IProgressCallback
	{
		...
		void setCancelMessage(string text);
	  object[] getUserData();
		...
		/// <summary>
		/// Call this method from the worker thread to set the static progress text.
		/// </summary>
		/// <param name="text">The static progress text to display</param>
		/// <remarks>You must have called one of the Begin() methods prior to this call.</remarks>
